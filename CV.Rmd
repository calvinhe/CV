...
email: "calvinhe [at] stanford [dot] edu"
phone: 
headcolor: 414141
output: 
  vitae::moderncv:
...
tribble(
  ...
  "PhD in Economics", "Stanford University", "USA", "2021-2027 (expected)", "Fields: Macroeconomics and Finance",
  "BCom/BEc (Hons) in Economics", "University of New South Wales", "Australia", "2012-2016", "University Medal and First Class honours (WAM: 89.75)",
  "BCom/BEc (Hons) in Economics", "University of New South Wales", "Australia", "2012-2016", "Honours thesis: Sovereign Default Risk and the Fiscal Spending Multiplier",
  "BCom/BEc (Hons) in Economics", "University of New South Wales", "Australia", "2012-2016", "Supervisors: Richard Holden, Mariano Kulish and James Morley",
  "BCom/BEc (Hons) in Economics", "University of New South Wales", "Australia", "2012-2016", "Jan. - Jun. 2014: International exchange at University of California, Los Angeles (GPA: 3.96)"
) %>% 
...
tribble(
  ...
  "Jun. 2022 - present" , "Research Assistant", "Stanford University", "Research assistant for Adrien Auclert.",
  "Sept. 2023 - present" , "Teaching Assistant", "Stanford University", "Econ 102A (Fall '23), Econ 211 (Winter '23), Econ 43 (Spring '24).",
  "May 2018 - Aug. 2021", "Research Economist", "Reserve Bank of Australia", "I performed longer-term research on the Australian economy and monetary policy.",
  "May 2018 - Aug. 2021", "Research Economist", "Reserve Bank of Australia", "Research focus: monetary policy, financial frictions, housing market dynamics, firm productivity and life-cycle and forecasting methods.",
  ...
  "Feb. 2016 - Oct. 2016", "Tutor-in-charge", "University of New South Wales - School of Economics", "Facilitated implementation of course with over 1,000 students and managed a team of over 20 tutors.",
  "Feb. 2016 - Oct. 2016", "Tutor-in-charge", "University of New South Wales - School of Economics", "Awarded the 2016 UNSW Business School Excellence in Tutoring Award.",
   "Mar. 2015 - Jun. 2020", "Tutor/Demonstrator", "University of New South Wales - School of Economics", "Tutor for Microeconomics 1 (Econ1101): 2015, 2016, and 2019 (T1 and T2).",
...
1. Nominal Exposures, Monetary Policy and Investment (joint with Otavio Rubiao)
2. Policy Evaluation with Heterogeneous Agents (joint with Raman Singh Chhina)
...
tribble(
  ~dates, ~role,
  "Programming", "R (preferred), Python (preferred), Julia, SQL, Matlab"
) %>% 
